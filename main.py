    """
    Ner Extractor 1te1dg1
    =====================
    Developer-friendly AI library that helps you summarise documents programmatically.
    ...
    APP_NAME    = "Ner Extractor 1te1dg1"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you summarise documents programmatically.")
